...
- [x] 1.1 Add query form state for knowledgeBaseId, queryText, minScore (0.7), and limit (5) with a manual search
  trigger.
- [x] 1.2 Add API client/types for chunk search results and render the results table with score sorting and
